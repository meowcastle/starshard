...
FRONTEND_FILES="manzil-copy.js api.js astro.js format.js reading.js tz.js sky.js sigil.js sigil-copy.js reading-copy.js transits.js stations.js astronomy-engine.js support.js sitemap.xml combos.js findings.js rates.js ios-frame.jsx four-skies.dc.html socket-io-client.js ephemeris2.js manzil-art2.js"
