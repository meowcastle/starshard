...
FRONTEND_FILES="api.js astro.js format.js reading.js tz.js sky.js sigil.js sigil-copy.js reading-copy.js transits.js deck.js events.js stations.js astronomy-engine.js support.js sitemap.xml"
