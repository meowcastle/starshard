...
//   2. Every built level, opened cold AND PLAYED — twenty-seven mansions, each booted from a fresh
...
for (const [id, name] of [[1,'gate'],[2,'bearer'],[3,'gathered stars'],[4,'follower'],[5,'blaze'],[6,'storm'],[7,'return'],[8,'ghost'],[9,'glance'],[10,'throne'],[11,'mane'],[12,'turning'],[13,'hand'],[14,'jewel'],[15,'veil'],[16,'claws'],[17,'crown'],[18,'heart'],[19,'root'],[20,'flock'],[21,'empty district'],[23,'drum'],[24,'void'],[25,'hideaway'],[26,'chamber'],[27,'causeway'],[28,'thread']]) {
...
for (const [id, name] of [[1,'gate'],[3,'gathered stars'],[5,'blaze'],[6,'storm'],[9,'glance'],[15,'veil'],[18,'heart'],[20,'flock'],[23,'drum'],[24,'void'],[27,'causeway']]) {
  const r = await withPage(browser, { [K + 'moon']: String(id) }, async page => {
