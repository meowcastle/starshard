...
//   2. Every built level, opened cold — six mansions, each booted from a fresh
...
for (const [id, name] of [[10,'throne'],[18,'heart'],[21,'empty district'],[23,'drum'],[25,'hideaway'],[28,'thread']]) {
