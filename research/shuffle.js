...
const HEAD="  how the twelve is drawn         awake  taps  careful  casual    gap   close%  blow%";
const START={l4:0,l3:1,l2:5}, MONTH={l4:0,l3:2,l2:12};

console.log("THE SHUFFLE IS THE LEVER. You own six awake cards out of twenty-eight, so a");
console.log("twelve-card draw hands you two or three of them. Three ways to draw:\n");
console.log("NIGHT ONE (sun at L3, five planets at L2), mansion at rung 9, hand 7");
console.log(HEAD);
show("straight draw from all 28",        pair(9, START, 2, 7, null));
show("your best card always dealt",      pair(9, START, 2, 7, "sun"));
show("your awake cards drawn first",     pair(9, START, 2, 7, "awake"));
console.log("\nA MONTH IN (2 at L3, 12 at L2)");
console.log(HEAD);
show("straight draw from all 28",        pair(9, MONTH, 2, 7, null));
show("your best card always dealt",      pair(9, MONTH, 2, 7, "sun"));
show("your awake cards drawn first",     pair(9, MONTH, 2, 7, "awake"));
