# Corpus batch 7 — houses, aspects, special nights, fallbacks

*Star Shard reading corpus · August 13, 2026 · the content bills Design
left as labelled slots. Written at the sharpened bar (`WRITING.md`):
varied sentence length, concrete objects, one specific detail per
passage, a named cost. Same marker format — the build tool parses this
file unchanged; add it to the file list in
`tools/build-reading-copy.mjs`.*

**Slot IDs are mine, not Design's.** Their manifests
(`DEEP-CHART-BINDINGS.md`, `DAILY-BINDINGS.md`) aren't in the repo yet.
Code maps these to whatever names the manifests use — or, simpler,
Design adopts these. Either way the mapping is one table, done once.

---

## HOUSE — the twelve arenas (Deep Chart · HOUSES tab)

*Each passage describes the place. The composer prefixes it with which
light landed there: "your sun plays out here" / "your moon lives here."
Written so either reads naturally.*

**HOUSE.01**
the first house is the doorway — the sky that was climbing over the
horizon at your minute, and the part of you that arrives before the
rest. your body lives here. so does the walk, the voice, the face you
make when you don't know you're being watched.
whatever light you have here, people meet it first and assume it's the
whole story. it isn't. but you'll spend a while being introduced as a
version of yourself that's technically accurate and about a third of
the truth.
...
**HOUSE.03**
the third house is the near world. the six blocks around you. siblings,
...
**HOUSE.07**
the seventh house sits directly across from the doorway: the other
...
you inherited. what happens with the lights off, and what happens when
something ends.
...
you'd argue for at 2am. anything more than a day's travel from where
you started.
...
**HOUSE.10**
the tenth house is the top of the chart — the point directly overhead
...
**HOUSE.11**
the eleventh house is your people. friends, scenes, the group, the
...
**HOUSE.12**
the twelfth house is the back room. solitude, sleep, the hospital, the
...
## ASPECT — the geometry between your lights (Deep Chart · PATTERN tab)

*The ten most common. The gait passage says how you walk; these say how
the two parts negotiate. Different job, no overlap. Every one states
its orb — the composer supplies the number.*

**ASPECT.sunmoon.conjunction**
your sun and moon were in the same stretch of sky — which means you
were born at a new moon, with no moon visible at all.
there's no gap in you between what you want and how you feel about
wanting it. most people run a negotiation. you don't have the seam.
it makes you very hard to talk out of things, and it means you have no
second opinion in the building. when you're right, nothing stops you.
when you're wrong, there is nobody inside your own chart to say so, and
you have to go outside and find that person on purpose.

**ASPECT.sunmoon.opposition**
your sun and moon stood across the whole width of the sky from each
other. that's a full moon, and that's why the night you arrived was
bright.
...
your sun and moon sit at a right angle — the tense one, the grinding
one.
...
your sun and rising sit comfortably apart. the entrance matches the
person.
...
people read your mood before you've spoken and often before you've
noticed it yourself. it makes you unusually easy to be close to and
almost impossible to hide in. you learned early to manage a room by
managing your face, and it's exhausting in a way you can't easily
describe to someone whose feelings stay indoors.

**ASPECT.moonrising.opposition**
your moon sits opposite the horizon — down at the base of the chart,
...
## NIGHT — the four special crossings (Daily · hand-written, never generated)

*These fire when tonight's station is one of the traveler's own. Roughly
once a month each. They must never be left to the model.*
...
**NIGHT.moon**
tonight the moon is back in the sky it was in when you were born.
same station, same stretch, roughly once every twenty-seven days for
your entire life — including the first night, which you don't
remember. if you've ever noticed a mood that arrives on a schedule and
doesn't attach to anything, this is a candidate. tonight is a good
night to not make decisions and a very good night to sleep early.

**NIGHT.rising**
tonight the moon crosses the sky that was climbing over the horizon
when you arrived.
this is the door you come through, lit up for one night. the effect is
usually social — you're read more accurately than usual, or you finally
say the thing in the way you meant it. if there's a conversation you've
been rehearsing, this is the night the doorway is open.
...
month you get to see your own position from across the water.

**NIGHT.extra.eclipse** *(EXTRA — not in the current build)*
there's an eclipse tonight, and it lands in your chart. these are rare
enough that the old astronomers kept separate records for them.

---

## FALLBACK — when generation fails (Daily · ships silently)

*The user must never see an error where a reading should be. These are
good enough that nobody notices. One per cast kind, plus a generic.*
...
toward the next. nights like this are better for finishing than
starting. pick the thing that's nearly done.

**FALLBACK.threshold**
the moon is sitting right on the edge between two stations tonight —
a narrow window, a few hours wide. thresholds don't come with
...
the jacket, the drive you could do asleep, the studio at 4am), and a
cost that costs something. HOUSE.12's ending — *"you'll hear it first
from someone who loves you and finally said it"* — is the register I'd
like the whole corpus rewritten to.

**No overlap with the gait passages.** The gait says how you walk;
`ASPECT.sunmoon.*` says how the two parts negotiate. Both cover the
sun–moon relationship and they were written side by side to make sure
they say different things. Seedborn/new-moon and Farbank/full-moon are
the two places to watch on any future edit.

**Blocked on nothing.** The engine already computes houses; aspects are
~40 lines (PRODUCT §3); the special nights only need the
station-equality check that `sigil.js` already has the data for.

**One flag for Design, and it matters:** the merge target should be
**`Star Shard v3.dc.html`** — that's the live page, updated today. The
file named in the handoff, `Star Shard v2.dc.html`, doesn't exist under
that name; what's in the repo is `Star Shard v2 (archived).dc.html`,
which is the *retired* pre-reboot page kept only as reference per the
CLAUDE.md receipt protocol. Merging the arrival into the archived
page's phone tree would be work thrown away.
